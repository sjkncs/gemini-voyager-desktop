...
export default function Popup() {
  ...
  // Consolidated settings state via useReducer (replaces ~15 individual useState calls)
  const { settings, updateSetting } = usePopupSettings();
  const {
    mode,
    hideContainer,
    draggableTimeline,
    ...
    customWebsites,
    formulaCopyFormat,
    watermarkRemoverEnabled,
    hidePromptManager,
    inputCollapseEnabled,
    tabTitleUpdateEnabled,
    mermaidEnabled,
    quoteReplyEnabled,
  ...
  // UI-only state (not persisted to storage)
  ...
  const handleFormulaCopyFormatChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    updateSetting('formulaCopyFormat', format);
  }, [updateSetting]);
  ...
  // Reconcile stored custom websites with actual granted permissions on mount.
  useEffect(() => {
    if (!customWebsites.length) return;
    ...
    void (async () => {
      ...
      const filtered = (
        await Promise.all(
          customWebsites.map(async (domain: string) => ({
            domain,
      ...
      if (filtered.length !== customWebsites.length) {
        updateSetting('customWebsites', filtered);
      }
    })();
  }, [customWebsites.length]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  const handleAddWebsite = useCallback(async () => {
    ...
    updateSetting('customWebsites', updatedWebsites);
    setNewWebsiteInput('');

    const granted = await requestCustomWebsitePermission(normalized);
    if (!granted) {
      updateSetting('customWebsites', customWebsites);
    }
  }, [
    newWebsiteInput,
    customWebsites,
  ...
  const handleRemoveWebsite = useCallback(
    ...
    [customWebsites, revokeCustomWebsitePermission, updateSetting],
  );
  ...
  const toggleQuickWebsite = useCallback(
    async (domain: string, isEnabled: boolean) => {
      if (isEnabled) {
        ...
        updateSetting('customWebsites', updated);
    ...
    [customWebsites, requestCustomWebsitePermission, revokeCustomWebsitePermission, updateSetting],
  );
          ...
          <CardContent className="space-y-4 p-0">
            ...
            <div>
              ...
              <div className="bg-secondary/50 relative grid grid-cols-2 gap-1 rounded-lg p-1">
                <div
                  className={`bg-primary pointer-events-none absolute top-1 bottom-1 w-[calc(50%-6px)] rounded-md shadow-md transition-all duration-300 ease-out ${mode === 'flow' ? 'left-1' : 'left-[calc(50%+2px)]'}`}
                />
                <button
            ...
            <div className="group flex items-center justify-between">
              ...
              <Switch
                ...
                onChange={(e) => {
                  updateSetting('hideContainer', e.target.checked);
                }}
              />
            </div>
            <div className="group flex items-center justify-between">
              ...
              <Switch
                ...
                onChange={(e) => {
                  updateSetting('draggableTimeline', e.target.checked);
                }}
              />
            </div>
            <div className="group flex items-center justify-between">
              <div className="flex-1">
                ...
                >
                  {t('enableMarkerLevel')}
                  <span
                    className="material-symbols-outlined cursor-help text-[16px] leading-none opacity-50 transition-opacity hover:opacity-100 [font-variation-settings:'FILL'_0,'wght'_400,'GRAD'_0,'opsz'_20]"
              ...
              <Switch
                ...
                onChange={(e) => {
                  updateSetting('markerLevelEnabled', e.target.checked);
                }}
              />
            </div>
            ...
            <Button
              ...
              onClick={() => {
                try { chrome.storage?.sync?.set({ geminiTimelinePosition: null }); } catch {}
              }}
            >
          ...
          <CardContent className="space-y-4 p-0">
            <div className="group flex items-center justify-between">
              ...
              <Switch
                ...
                onChange={(e) => {
                  updateSetting('folderEnabled', e.target.checked);
                }}
              />
            </div>
            <div className="group flex items-center justify-between">
              ...
              <Switch
                ...
                onChange={(e) => {
                  updateSetting('hideArchivedConversations', e.target.checked);
                }}
              />
            </div>
          </CardContent>
            ...
            <CardContent className="p-0">
              <div className="group flex items-center justify-between">
                ...
                <Switch
                  ...
                  onChange={(e) => {
                    updateSetting('sidebarAutoHideEnabled', e.target.checked);
                  }}
                />
              </div>
            </CardContent>
          ...
          <CardContent className="space-y-4 p-0">
            <div className="group flex items-center justify-between">
              ...
              <Switch
                ...
                onChange={(e) => {
                  updateSetting('inputCollapseEnabled', e.target.checked);
                }}
              />
            </div>
            <div className="group flex items-center justify-between">
              ...
              <Switch
                ...
                onChange={(e) => {
                  updateSetting('ctrlEnterSendEnabled', e.target.checked);
                }}
              />
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-3 p-0">
            ...
            <div className="group flex items-center justify-between">
              ...
              <Switch
                ...
                onChange={(e) => {
                  updateSetting('hidePromptManager', e.target.checked);
                }}
              />
            </div>
            <div>
          ...
          <CardContent className="space-y-4 p-0">
            <div className="group flex items-center justify-between">
              ...
              <Switch
                ...
                onChange={(e) => {
                  updateSetting('tabTitleUpdateEnabled', e.target.checked);
                }}
              />
            </div>
            <div className="group flex items-center justify-between">
              ...
              <Switch
                ...
                onChange={(e) => {
                  updateSetting('mermaidEnabled', e.target.checked);
                }}
              />
            </div>
            <div className="group flex items-center justify-between">
              ...
              <Switch
                ...
                onChange={(e) => {
                  updateSetting('quoteReplyEnabled', e.target.checked);
                }}
              />
            </div>
          </CardContent>
            ...
            <CardContent className="space-y-4 p-0">
              <div className="group flex items-center justify-between">
                ...
                <Switch
                  ...
                  onChange={(e) => {
                    updateSetting('watermarkRemoverEnabled', e.target.checked);
                  }}
                />
              </div>
            </CardContent>
